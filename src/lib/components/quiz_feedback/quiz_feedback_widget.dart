...
import 'quiz_feedback_model.dart';
export 'quiz_feedback_model.dart';
...
class _QuizFeedbackWidgetState extends State<QuizFeedbackWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizFeedbackModel());

    _model.textController ??= TextEditingController(text: widget.feedbackText);
