...
DocumentReference? get currentUserReference =>
    loggedIn ? UserAccountsRecord.collection.doc(currentUser!.uid) : null;

UserAccountsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserAccountsRecord.getDocument(
                  UserAccountsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
