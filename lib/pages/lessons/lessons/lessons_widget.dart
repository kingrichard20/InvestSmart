...
class _LessonsWidgetState extends State<LessonsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.userLessonDocument = await queryLessonsRecordOnce(
        parent: currentUserReference,
        singleRecord: true,
      ).then((s) => s.firstOrNull);
      _model.chapter1 = _model.userLessonDocument?.chapter1IsComplete;
      _model.chapter2 = _model.userLessonDocument?.chapter2IsComplete;
      _model.chapter3 = _model.userLessonDocument?.chapter3IsComplete;
      _model.chapter4 = _model.userLessonDocument?.chapter4IsComplete;
      _model.chapter5 = _model.userLessonDocument?.chapter5IsComplete;
      safeSetState(() {});
    });
  }
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(6.0, 2.5, 0.0, 0.0),
                        child: Text(
