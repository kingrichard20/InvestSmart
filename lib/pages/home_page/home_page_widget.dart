...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  void initState() {
    ...
    _model.suUserNameTextController ??= TextEditingController();
    _model.suUserNameFocusNode ??= FocusNode();
    ...
    _model.suPhonenumbTextController ??= TextEditingController();
    _model.suPhonenumbFocusNode ??= FocusNode();
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      enableInteractiveSelection:
                                                          true,
                                                      validator: _model
                                                          .suUserNameTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                  Container(
                                                  ...
                                                  Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .suPhonenumbTextController,
                                                      focusNode: _model
                                                          .suPhonenumbFocusNode,
                                                      autofocus: false,
                                                      enabled: true,
                                                      obscureText: false,
                                                      decoration:
                                                      ...
                                                      enableInteractiveSelection:
                                                          true,
                                                      validator: _model
                                                          .suPhonenumbTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ],
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.suPasswordTextController.text !=
                                        _model.suConfirmPasswordTextController
                                            .text) {
                                    ...
                                    await UserAccountsRecord.collection
                                        ...
                                        .update(createUserAccountsRecordData(
                                          ...
                                          displayName: _model
                                              .suUserNameTextController.text,
                                        ));

                                    context.pushNamedAuth(
                                        Screen2Widget.routeName,
                                        context.mounted);
                                  },
                                  text: 'Sign Up',
                              ...
                              if (_model.tabBarCurrentIndex == 1)
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    context.goNamedAuth(Screen2Widget.routeName,
                                        context.mounted);
                                  },
                                  text: 'Log In',
                                  options: FFButtonOptions(
