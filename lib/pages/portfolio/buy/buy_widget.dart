  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((_model.assetInfo?.succeeded ?? true)) {
        ...
        _model.bookValue = GetAssetInfoCall.bookValue(
          (_model.assetInfo?.jsonBody ?? ''),
        );
        ...
        _model.profitMargin = GetAssetInfoCall.profitMargin(
          (_model.assetInfo?.jsonBody ?? ''),
        );
      ...
      if ((_model.assetPrice?.succeeded ?? true)) {
        _model.todaysChange = GetAssetPriceCall.change(
          (_model.assetPrice?.jsonBody ?? ''),
        );
        _model.todaysChangePercent = GetAssetPriceCall.changePercent(
          (_model.assetPrice?.jsonBody ?? ''),
        );
        _model.price = GetAssetPriceCall.currentPrice(
          (_model.assetPrice?.jsonBody ?? ''),
        );
        _model.totalCost = '0';
        _model.shares = '0';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            controller: _model.sharesToBuyTextController,
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              () async {
                                _model.shares =
                                    (_model.sharesToBuyFocusNode?.hasFocus ??
                                            false)
                                        .toString();
                                safeSetState(() {});
                                _model.totalCost =
                                    (double.parse((_model.price!)) *
                                            double.parse((_model.shares!)))
                                        .toString();
                                safeSetState(() {});
                              },
                            ),
                            ...
                            validator: _model.sharesToBuyTextControllerValidator
                                .asValidator(context),
                          ),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                _model.sharesToBuyTextController.text,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (_model.sharesToBuyTextController.text != '') {
                                ...
                                if (_model.holdingsDocument != null) {
                                  await _model.holdingsDocument!.reference
                                    ...
                                    averageCost: ((double.parse(_model
                                                    .holdingsDocument!
                                                    .averageCost) +
                                                double.parse((_model.price!))) /
                                            (double.parse((_model.shares!)) +
